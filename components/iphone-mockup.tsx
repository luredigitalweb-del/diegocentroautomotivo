...
/**
 * Mockup SVG de iPhone 16 Pro.
 * O conteúdo (vídeo/imagem) é uma camada HTML posicionada sobre a área do
 * ecrã — evita o <foreignObject>, que tem bugs de altura no Safari/iOS.
 */
export function IphoneMockup({
  ...
  return (
    <div className={cn("relative", className)}>
      ...
      {/* Conteúdo do ecrã (camada HTML — compatível com iOS) */}
      {children && (
        <div
